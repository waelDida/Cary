package com.projects.mycompany.cary.caregiver.giversettings
...
import com.projects.mycompany.cary.databinding.FragmentGiverSettingsBinding
...
class GiverSettingsFragment : Fragment() {

    private lateinit var binding: FragmentGiverSettingsBinding
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.fragment_giver_settings, container, false)
        binding = FragmentGiverSettingsBinding.inflate(inflater)
        ...
        binding.editProfileLayout.setOnClickListener {
            findNavController().navigate(GiverSettingsFragmentDirections.actionGiverSeetingsToEditGiverProfile())
        }
        ...
        confirm.setOnClickListener {
            if(editPassword.text.toString().isNotEmpty()){
                ...
                getCurrentUser()!!.reauthenticate(credential).addOnCompleteListener {
                    if(it.isSuccessful){
                        dialog.dismiss()
                        findNavController().navigate(GiverSettingsFragmentDirections.actionSettingsItemToDeleteCareGiverData())
                    }
