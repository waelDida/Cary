...
class CurrentReviews : Fragment() {
    ...
    override fun onCreateView(
       ...
       inflater.inflate(R.layout.fragment_current_reviews, container, false)
        val binding = FragmentCurrentReviewsBinding.inflate(inflater)

        val adapter = GiverReviewsAdapter()

        val viewModelFactory = GiverReviewsVMFactory(getCurrentUser()!!.uid, (requireContext().applicationContext as ToDoApplication).reviewsDataRepository)
